package tryharder.tweetr.prototype
{
	...
	{
        // You will have to create this file. You really don't want to commit
        ...
        //  }
        //
        // Stick it in the same folder as this file as "credentials.json"
        [Embed(source="credentials.json",mimeType="application/octet-stream")]
        private const CREDENTIALS_JSON:Class;
		...
		public function Main()
		{
            ...
            var credentials:Object = JSON.parse(new CREDENTIALS_JSON());

            _oauth = new OAuth();
            _oauth.consumerKey = credentials.key;
            _oauth.consumerSecret = credentials.secret;
